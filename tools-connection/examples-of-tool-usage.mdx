...
<iframe
  ...
  src="https://www.youtube.com/embed/wvagsFljnGM"
  title="Gmail MCP in action"
  frameBorder="0"
...
<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/v1Z9gbryHxU"
  title="Odoo MCP demonstration"
  frameBorder="0"
  allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>
...
<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/-AmDAj4vGQc"
  title="Multi-tool MCP: Gmail and Odoo contact overview"
  frameBorder="0"
  allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>
