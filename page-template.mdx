...
Make your prompts flexible and reusable with variables—placeholders that you customize each time you use a template. WonkaChat supports three types of variables: **basic variables** for custom input, **special variables** that auto-populate with system information, and **dropdown variables** for predefined options.
