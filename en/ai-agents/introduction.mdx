...
<CardGroup cols={2}>
  <Card
    ...
    href="/en/ai-agents/finding-and-accessing-agents"
  >
  ...
  <Card
    ...
    icon="play"
    href="/en/ai-agents/using-existing-agents"
  >
  ...
  <Card
    ...
    icon="plus-circle"
    href="/en/ai-agents/creating-your-first-agent"
  >
  ...
  <Card
    ...
    icon="graduation-cap"
    href="/en/ai-agents/business-teaching"
  >
