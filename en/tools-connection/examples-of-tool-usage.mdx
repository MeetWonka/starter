...
description: "See external connections (MCP) in action with real examples of Outlook, Odoo, and other business systems."
---
...
<iframe
  ...
  title="Gmail connection in action"
  frameBorder="0"
...
<iframe
  ...
  title="Odoo connection demonstration"
  frameBorder="0"
  allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>
...
<iframe
  ...
  title="Multi-tool: Gmail and Odoo contact overview"
  frameBorder="0"
  allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>
