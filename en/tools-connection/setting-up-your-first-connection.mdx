...
<Tab title="API Key">
<Info>
Some softwares require an API key. If you need assistance obtaining or using your API key, see the <a href="/en/support-resources/getting-help">Getting Help</a> page for personalized support options.
</Info>
...
<Tab title="Custom">
<Info>
Some business systems, such as <strong>Odoo</strong>, require custom configuration beyond standard authentication. If you need assistance to connect, see the <a href="/en/support-resources/getting-help">Getting Help</a> page for personalized support options.
</Info>
...
<CardGroup cols={2}>
<Card title="Troubleshooting" icon="wrench" href="/en/tools-connection/troubleshooting-connections">
Having issues with connecting your business systems? Find solutions to common connection problems.
</Card>

<Card title="See Examples" icon="video" href="/en/tools-connection/examples-of-tool-usage">
