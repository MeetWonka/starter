...
The **system prompt** is the foundational set of instructions that defines your agent's identity and behavior. Unlike regular conversation messages that can be modified or ignored, the system prompt is persistent and authoritative—it shapes every response the agent generates.
...
**Tools (MCP Connections)**: The most important capability—direct integration with your business systems through the Model Context Protocol.

Agents dynamically select which tools to use based on the task and their system prompt guidance.

<Info>
**MCP tools** connect agents to your business systems for real actions.\
...
<Warning>
Agents provide no privilege escalation. All operations execute with your user permissions.
</Warning>

### Agent Management

**Administrators:**
- Create and share organization-wide agents
- Control which agents are available to all users
- Configure tool access and permissions

**Standard Users:**
- Use shared agents (cannot modify them)
- Create personal agents for individual workflows
- Request administrator approval to share agents organization-wide
