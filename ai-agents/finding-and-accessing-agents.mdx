...
Access the agent marketplace from the top left of your screen. The marketplace organizes agents by categories, making it easy to discover and browse available agents—especially useful when you have many agents to choose from.
...
Access your agents directly from the model selection dropdown at the top of the screen. At the bottom of the dropdown, you'll see "My Agents"—hover over it to reveal a list of all your available agents with a search field.
