...
<Tip>
WonkaChat maintains strict security boundaries — AI agents cannot override or escalate permissions in your connected tools.
</Tip>
...
<CardGroup cols={2}>
  ...
  >
    Configure granular permissions to control which users can access specific tools, agents, and functionalities
  </Card>
